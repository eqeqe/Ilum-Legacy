...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'chatspy / cspy', DESC = 'Readprivatechatsduh.'}
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/eqeqe/Ilum-Legacy/refs/heads/main/y'))()")
	end
end)
...
addcmd('chatspy', {'cspy'}, function(args, speaker)
	notify('Loading', 'Hold on a sec')
	loadstring(game:HttpGet("https://raw.githubusercontent.com/eqeqe/Ilum-Legacy/refs/heads/main/chat"))()
end)
